                ...
                <!-- Hero -->
                    ...
                    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
                        ...
                        <h1 class="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-gray-200">
                            Let's Build
                            <span class="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">Fast</span>
                        </h1>
                        </div>
                        <!-- End Title -->

                        <div class="mt-5 max-w-3xl text-center mx-auto">
                        <p class="text-lg text-gray-600 dark:text-gray-400">Code snippets for lazy developers</p>
                        </div>
